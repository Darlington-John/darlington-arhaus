...
const AddOptions = (props: any) => {
   ...
   const { admin_furniture, group_products, type_products, product_view } =
      useParams();
   const {
   ...
   const handleAddOption = async (e: any) => {
      ...
      formData.append('furntureId', admin_furniture as any);
      formData.append('typeId', type_products as any);
      formData.append('productId', product_view as any);
