...
const VerifyEmail = () => {
   ...
   return (
      <div className="flex w-full items-center justify-center  h-full bg-white  min-h-screen  relative">
         <div className="flex-col gap-6   w-[400px]  flex items-center relative z-10   bg-[#fffffff5] py-4 px-4  rounded-sm ">
            <h1 className="  neue-thin tracking-wide text-center text-[40px] uppercase  leading-none">
               verification
            </h1>
